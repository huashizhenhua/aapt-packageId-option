...
public:
    Bundle(void)
        : mCmd(kCommandUnknown), mVerbose(false), mAndroidList(false),
          ...
          mPackageResId(127), mRJavaFileName("R"),
          mArgc(0), mArgv(NULL)
        {}
    ~Bundle(void) {}
    ...
    const char* getRJavaFileName() const { return mRJavaFileName; }
    void setRJavaFileName(const char* val) { mRJavaFileName = val; }
    

    int getPackageResId() { return mPackageResId; }
    void setPackageResId(int packageResId) { mPackageResId = packageResId; }
