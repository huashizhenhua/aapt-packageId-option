...
static const char* sRJavaFileName = "R";
...
status_t buildResources(Bundle* bundle, const sp<AaptAssets>& assets)
{
    ...
    if (table.hasResources()) {
        sp<AaptSymbols> symbols = assets->getSymbolsFor(String8(bundle->getRJavaFileName()));
                                    ...
                                    String16* outTypeComment = NULL)
{
    ...
    printf("sRJavaFileName = %s \n", sRJavaFileName);
    sp<AaptSymbols> asym = assets->getSymbolsFor(String8(sRJavaFileName));
    if (asym != NULL) {
    ...
    const String8& package, bool includePrivate)
{
    ...
    sRJavaFileName = bundle->getRJavaFileName();

    String8 R(sRJavaFileName);
